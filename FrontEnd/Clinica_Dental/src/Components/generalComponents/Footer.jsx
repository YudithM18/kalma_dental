  ...
  return (
    ...
    <div className="footer-container">
      ...
      <div className="footer-logo">
        <img className="Logo_principal" src={logo} alt="Logo de la clínica" />
      ...
      <div className="footer-socials">
        ...
        <img className="espejo" src={espejo} alt="Imagen decorativa espejo" />
      </div>
      ...
      <div className="footer-contacts">
        ...
        <div className="footer-contact-link">
          <a href="https://wa.me/c/50688208742" target="_blank" rel="noopener noreferrer" className="footer-social-icon whatsapp">
            <FaWhatsapp size="3em" />
          </a>
          <p>Whatsapp</p>
        </div> 
        <div className="footer-contact-link-email">
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=info@kalmadentalcr.com&su=Consulta%20de%20información&body=Hola,%20me%20gustaría%20obtener%20más%20información%20sobre%20sus%20servicios." target="_blank" rel="noopener noreferrer" className="footer-social-icon email">
            <MdEmail size="3em"/>
          </a> 
          <p>Email</p>
        </div>
      ...
      <div className="footer-hours">
        <img className="escritorio" src={escritorio} alt="Imagen decorativa escritorio" />
